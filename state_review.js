...
define(['text!./state_review.xml'], function( htmlString) {

	function state_review( params) { 
	...
	state_review.prototype.schema = {
		"Params": {
			"name": "state_review",
			"namespace": "state_review",
			"promoted": false
		},
		"Permalink": "https://spaforms365.com/docs/syslib-state_review/",
		"ListColumns" : {
    ...
    return { viewModel: state_review, template: htmlString };
});


 //@ sourceURL=state_review