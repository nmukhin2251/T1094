...
//define(['text!./transition_delete.xml', 'jsm-camelize'], function( htmlString, camelize) {
define(['text!./transition_delete.xml'], function( htmlString) {	
	
	/**
	 * COMPONENT VIEWMODEL CONSTRUCTOR
	 */
	function transition_delete( params) { 
//debugger;
		var _this = this;
		...
		var component = 'transition_delete';
...
// 		 * return d.promise();
// 		 * 
// 		 * Option 2: synchronous callback to cancel transition_delete.
// 		 * 			 all subsequent lifecycle events will be cancelled and the state will remain unchanged.
// 		 * return false;
// 		 * 
// 		 * Option 3: synchronous callback to continue transition_delete processing
// 		 * return true;
// 		 */
		var onBeforeClick = function(lifecycle) {
			...
			return true; // false - to cancel transition_delete
		};
        ...
        this.click = function () {
			f.workflow.fsm[f.workflow.fsm.camelize(id)](f.state()); // trigger transition_delete execution;
		};
    ...
    //componenttransition_delete.prototype.doSomething = function() { ... };
	transition_delete.prototype.schema = {
		"Params": {
			"namespace": "listItem",
			"visible": true,
    ...
    return { viewModel: transition_delete, template: htmlString };
});


 //@ sourceURL=transition_delete